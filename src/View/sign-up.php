...
<head>
    ...
    <?php require_once("template/form-head.html");  ?>
...
<body>
    <main class="container">
        ...
        <?php if ($stage === 1) : ?>
            ...
            <h1 class="heading">Sign up to Company</h1>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form-container" id="sign-up-form" autocomplete="off" spellcheck="false">
                <div class="input-area">
                    <input type="text" name="name" class="name" id="sign-up-name" placeholder="Name">
                </div>
                <div class="input-area">
                ...
                <div class="input-area">
                    <input type="password" name="repeat-password" class="repeat-password" id="sign-up-repeat-password" placeholder="Repeat Password">
                </div>
                <div id="sign-up-submit-area">
                    <input type="submit" class="submit" id="sign-up-submit" value="Sign up">
                </div>
            </form>
        ...
        <?php elseif ($stage === 2) : ?>
            ...
            <div id="success-field">
                <p class="success-message">The link to register your account has been sent to <b><?= strtolower($_POST["email"]); ?></b>. </p>
                <p class="success-message">Please open the link to continue the registration.</p>
            </div>
