...
<form action="../php/database/password-reset-process.php" method="post" class="form-container" id="account-recovery-form" autocomplete="off" spellcheck="false">
    <p class="message">Reset your password below:</p>
    <div class="input-area">
        <input type="password" name="password" class="password" id="account-recovery-password" placeholder="Password">
    </div>
    <div class="input-area">
        <input type="password" name="repeat-password" class="repeat-password" id="account-recovery-repeat-password" placeholder="Repeat Password">
    </div>
