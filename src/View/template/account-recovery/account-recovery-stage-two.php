...
<h1 class="heading">Reset Password Email Sent</h1>
<div id="success-field">
    <p class="message">The link to reset your account password has been sent to <b>
            <?= strtolower($_POST["email"]); ?>
        </b>. </p>
    <p class="message">Please open the link to reset your password.</p>
</div>