...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form-container" id="sign-up-form" autocomplete="off" spellcheck="false">
    <div class="input-area">
        <input type="text" name="name" class="name" id="sign-up-name" placeholder="Name" value="<?php echo $savedName ?>">
    </div>
    <div class="input-area">
        <input type="email" name="email" class="email" id="sign-up-email" placeholder="Email" value="<?php echo $savedEmail ?> ">
